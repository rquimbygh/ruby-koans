...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    assert_equal :class_method, MessageCatcher2.send(:caught?)
    assert_equal :class_method, MessageCatcher2.__send__(:caught?)

    # THINK ABOUT IT:
    #
    # Why does Ruby provide both send and __send__ ?
    # A: __send__ is defined on the Object (all objects of any class inherit this method).
    #    send is defined on the Class and can be overriden for all instances and class references to that class.
  end
